...
P2AFLAGS_gb     = -map -use_map_attributes -bpp 2 -max_palettes 4 -spr16x16msx -pack_mode gb -no_palettes -noflip
P2AFLAGS_gbc    = -map -use_map_attributes -bpp 2 -max_palettes 8 -spr16x16msx -pack_mode gb -noflip
...
# Compile .s assembly files in "src/EXT/" to .o object files
